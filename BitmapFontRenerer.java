...
public class BitmapFontRenerer {
    ...
    public BitmapFontRenerer(String fontRes, int cols, int rows){
    ...
    private void loadFont(BufferedImage image, Integer cols, Integer rows){
        ...
        for (int y = 0; y <rows; y++){
            for (int x = 0; x < cols; x++){
                ...
                ig.drawImage(bitmapFontImage,0 ,0,letterWidth,letterHeight,x*letterWidth,y*letterHeight,
